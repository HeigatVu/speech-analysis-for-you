...
def clapperboard_detection(
    ...
    mono_clapperboard_sound_effect_array = np.array(mono_clapperboard_sound_effect.get_array_of_samples(), dtype=float)
    ...
    # Cross-correlation
    correlation = signal.correlate(mono_raw_audio_array_norm, mono_clapperboard_sound_effect_array_norm, mode="full")
    ...
    visualization = uVisualization.correlation_visualization(lag, correlation, threshold, save_path=save_viz_cor_path)
